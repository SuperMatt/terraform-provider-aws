...
func TestAccAuditManagerFrameworkShare_Identity_basic(t *testing.T) {
	...
	acctest.ParallelTest(ctx, t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			// Step 1: Setup
			{
				ConfigDirectory: config.StaticDirectory("testdata/FrameworkShare/basic/"),
				ConfigVariables: config.Variables{
					acctest.CtRName:    config.StringVariable(rName),
					"secondary_region": config.StringVariable(acctest.AlternateRegion()),
				},
				Check: resource.ComposeAggregateTestCheckFunc(
					testAccCheckFrameworkShareExists(ctx, t, resourceName),
				),
...
func TestAccAuditManagerFrameworkShare_Identity_regionOverride(t *testing.T) {
	ctx := acctest.Context(t)
	...
	acctest.ParallelTest(ctx, t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			// Step 1: Setup
			{
				ConfigDirectory: config.StaticDirectory("testdata/FrameworkShare/region_override/"),
				ConfigVariables: config.Variables{
					acctest.CtRName:    config.StringVariable(rName),
...
func TestAccAuditManagerFrameworkShare_Identity_ExistingResource_basic(t *testing.T) {
	ctx := acctest.Context(t)
	...
	acctest.ParallelTest(ctx, t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				ConfigDirectory: config.StaticDirectory("testdata/FrameworkShare/basic_v6.41.0/"),
				ConfigVariables: config.Variables{
					acctest.CtRName:    config.StringVariable(rName),
					"secondary_region": config.StringVariable(acctest.AlternateRegion()),
				},
...
// Resource Identity was added after v6.41.0
func TestAccAuditManagerFrameworkShare_Identity_ExistingResource_noRefreshNoChange(t *testing.T) {
	ctx := acctest.Context(t)
